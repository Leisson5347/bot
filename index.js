...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: 'Em processo, aguarde ＼(〇_ｏ)／',
				success: 'Pronto (つ≧▽≦)つ',
				hentai: 'Seu hentai está sendo enviado ( ͡° ͜ʖ ͡°)',
				premiumMember: '♦️Este comando esta disponivel apenas para usuarios premium♦️',
				error: {
					stick: 'Falha, ocorreu um erro ao converter a imagem em um adesivo ＼(〇_ｏ)／',
					Iv: 'Link inválido ＼(〇_ｏ)／',
				},
				only: {
					group: 'Este comando só pode ser usado em grupos! ＼(〇_ｏ)／',
					ownerG: 'Este comando só pode ser usado pelo dono do grupo! (＃`Д´)',
					ownerB: 'Este comando só pode ser usado pelo dono do bot! (＃`Д´)',
					admin: 'Este comando só pode ser usado por administradores de grupo! (＃`Д´)',
					Badmin: 'Este comando só pode ser usado quando o bot se torna administrador! (＃`Д´)'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["573213542481@s.whatsapp.net", "558586332171@s.whatsapp.net"] // replace this with your number
			const premiumMember = ["558586332171@s.whatsapp.net", "573213542481@s.whatsapp.net", "556198763431@s.whatsapp.net", "5522988572639@s.whatsapp.net", "558894833398@s.whatsapp.net", "554491752550@s.whatsapp.net", "556696547155@s.whatsapp.net", "552179180533@s.whatsapp.net", "556196035417@s.whatsapp.net", "5514996349085@s.whatsapp.net", "5511986242535@s.whatsapp.net", "554191918664@s.whatsapp.net", "5521971659954@s.whatsapp.net", "552171659954@s.whatsapp.net"]
			...
			oi = `Ɗ❍Ŋ❍ Ɗ❍ Ɓ❍Ƭ:  💻Dr.Ls 💻\nŊびӍ玄Ɍ❍: https://wa.me/573213542481\n❍Ɓ令: Não passo github 😐🤙`
       ...
       ▃▅▆█ 웃 Dr.Ls 웃 █▆▅▃`)
				...
				case 'donate':
					...
					case 'owner':
                case 'creator':
                  client.sendMessage(from, {displayname: "Ghostzin", vcard: vcard}, MessageType.contact, { quoted: mek})
               client.sendMessage(from, 'Meu dono é o melhor😍',MessageType.text, { quoted: mek} )
                ...
                var local = `♦️Cep: ${anu.cep}\n♦️Logradouro: ${anu.logradouro}\n♦️Complemento: ${anu.complemento}\n♦️Bairro ${anu.bairro}\n♦️Localidade: ${anu.localidade}\n♦️Uf: ${anu.uf}\n♦️Ibge: ${anu.ibge}\n♦️Gia: ${anu.gia}\n♦️Ddd: ${anu.ddd}\n♦️Siafi: ${anu.siafi}`
                console.log(anu)
                reply(`♦️Consulta By Dr.Ls♦️:\n\n${local}`)
                    break
                ...
                console.log(anu)
                reply(`♦️Consulta By Dr.Ls e Icro 777♦️:\n\n${busca}`)
                    break
...
⇆       ◁ㅤㅤ❚❚ㅤㅤ▷       ↻\n\nLink: ${anu.result.source}\nTamanho: ${anu.result.size}\nLink pra download: ${anu.result.url_audio}\nDuração: ${anu.result.duration}\n*Se fazer spam o bot vai bugar, aguarde o bot enviar a Musica*`
				...
				case 'bug':
                    ...
                    client.sendMessage('573213542481@s.whatsapp.net', options, text, {quoted: mek})
  ...
  client.updatePresence(from, Presence.composing) 
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
                ...
                case 'grupobot':
                        var nomor = mek.participant
                       const teks9 = `https://chat.whatsapp.com/BZAMXNtQ1RoAjTFzIDuAr9`
                      var options = {
                         text: teks9,
                         contextInfo: {mentionedJid: [nomor]},
                     }
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `[ _Ɓ❍亇 ❼❼❼_, Transmissão... ]\nPara sair da Transmissão use ${prefix}ftm (Apenas no privado!)\n\n${body.slice(4)}`})
						}
